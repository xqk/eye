...
ASGI_APPLICATION = 'eye.routing.application'
...
SCHEDULE_KEY = 'eye:schedule'
SCHEDULE_WORKER_KEY = 'eye:schedule:worker'
MONITOR_KEY = 'eye:monitor'
MONITOR_WORKER_KEY = 'eye:monitor:worker'
EXEC_WORKER_KEY = 'eye:exec:worker'
REQUEST_KEY = 'eye:request'
BUILD_KEY = 'eye:build'
