...
import LogoeyeText from 'layout/logo-eye-txt.png';
...
function WebSSH(props) {
  ...
  useEffect(() => {
    window.document.title = 'eye web terminal'
  ...
  return hasPermission('host.console.view') ? (
    <div className={styles.container} onMouseUp={() => posX = 0} onMouseMove={handleMouseMove}>
      ...
      <div className={styles.content}>
        ...
        {hosts.length === 0 && (
          <pre className={styles.fig}>{eye_web_terminal}</pre>
        )}
      </div>
