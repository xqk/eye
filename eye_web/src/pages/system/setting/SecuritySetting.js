...
export default observer(function () {
  ...
  function handleChangeMFA(v) {
    if (v && !store.settings.eye_key) return message.error('开启MFA认证需要先在基本设置中配置调用凭据');
        ...
        <Form.Item
          ...
          extra={visible ? '输入验证码，通过验证后开启。' :
            <span>建议开启，登录时额外使用验证码进行身份验证。开启前至少要确保管理员账户配置了微信Token（账户管理/编辑），开启后未配置微信Token的账户将无法登录，<a
              target="_blank" rel="noopener noreferrer" href="https://eye.icl.site/docs/wx-token/">什么是微信Token？</a></span>}>
          {visible ? (
