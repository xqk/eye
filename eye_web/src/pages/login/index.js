...
import logo from 'layout/logo-eye-txt.png';
        ...
        if (data['required_mfa']) {
          ...
          Modal.warning({
            ...
            content: <div>
              ...
              <a target="_blank"
                 href="https://eye.icl.site/docs/practice/"
    ...
    <div className={styles.container}>
      ...
      <div className={styles.footerZone}>
        <div className={styles.linksZone}>
          <a className={styles.links} title="官网" href="https://eye.icl.site" target="_blank"
             rel="noopener noreferrer">官网</a>
          <a className={styles.links} title="Github" href="https://github.com/xqk/eye" target="_blank"
             rel="noopener noreferrer"><GithubOutlined/></a>
          <a title="文档" href="https://eye.icl.site/docs/about-eye/" target="_blank"
             rel="noopener noreferrer">文档</a>
        </div>
        <div style={{color: 'rgba(0, 0, 0, .45)'}}>Copyright <CopyrightOutlined/> {new Date().getFullYear()} By xqk</div>
      </div>
    </div>
  )
}
